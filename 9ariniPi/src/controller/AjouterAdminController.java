...
public class AjouterAdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        while (ListeMembreController.connectedMembre != null) {
            ...
            m = ListeMembreController.connectedMembre;
        ...
        while (ListeAdminController.connectedAdmin != null) {
            ...
            zd_sitewebEntreprise.setVisible(false);
            zd_EntrpreneurUsage.setVisible(false);
            a = ListeAdminController.connectedAdmin;
        ...
        while (ListeFormateurController.connectedFormateur != null) {
            ...
            zd_sitewebEntreprise.setVisible(false);
            zd_EntrpreneurUsage.setVisible(false);
            f = ListeFormateurController.connectedFormateur;
        ...
        while (ListeEntrepreneurController.connectedEntrepreneur != null) {
            ...
            e = ListeEntrepreneurController.connectedEntrepreneur;
            ...
            public void handle(ActionEvent event) {
                ...
                if ((zd_Mdp.getText().equals(zd_CMdp.getText()))) {
                    if (zd_nom.getText().equals("") || zd_prenom.getText().equals("")
                        ...
                        if (zd_Role.getValue().equals(Membre)) {
                            if (zd_Mdp.getText().equals(null)) {
                                try {
                                    Membre p1 = new Membre(Integer.parseInt(zd_numtel.getText()), zd_Pdppath.getText(), zd_nom.getText(), zd_prenom.getText(),
                                            ...
                                            zd_Role.getValue(), zd_Org.getText(), zd_Fonction.getText(), sqlDate);
                                    System.out.println(p1.toString());

                                    ms.modifierMembre(p1, m);
                                    Alert a = new Alert(Alert.AlertType.WARNING);
                        ...
                        } else if (zd_Role.getValue().equals(Admin)) {
                            if (zd_Mdp.getText().equals(null)) {
                                try {
                        ...
                        } else if (zd_Role.getValue().equals(Formateur)) {
                            if (zd_Mdp.getText() != null) {
                                try {
                                ...
                                try {
                                    Formateur p1 = new Formateur(zd_Pdppath.getText(), Integer.parseInt(zd_numtel.getText()), zd_nom.getText(), zd_prenom.getText(),
                                            zd_adresse.getText(), zd_pays.getText(), ((RadioButton) zd_genre.getSelectedToggle()).getText(), zd_Email.getText(), zd_softskills.getText(),
                                            zd_Role.getValue(), zd_Org.getText(), zd_Fonction.getText(), sqlDate);
                                    System.out.println(p1.toString());
                        ...
                        } else if (zd_Role.getValue().equals(Entrepreneur)) {
                            if (zd_Mdp.getText().equals(null)) {
                                try {
                                ...
                                try {
                                    Entrepreneur p1 = new Entrepreneur(Integer.parseInt(zd_numtel.getText()), zd_Pdppath.getText(), zd_nom.getText(), zd_prenom.getText(),
                                            zd_adresse.getText(), zd_pays.getText(), ((RadioButton) zd_genre.getSelectedToggle()).getText(), zd_Email.getText(),
                                            zd_Role.getValue(), zd_Org.getText(), zd_Fonction.getText(), zd_nomeentrprise.getText(), zd_sitewebEntreprise.getText(), zd_EntrpreneurUsage.getText(), sqlDate);
                                    System.out.println(p1.toString());
                    ...
                    Alert a = new Alert(Alert.AlertType.WARNING);
                    a.setContentText("les mot de passe doivent etre identique  ");
                    a.setHeaderText(null);
                    a.showAndWait();
                }
