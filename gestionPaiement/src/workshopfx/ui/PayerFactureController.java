...
public class PayerFactureController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        prixTTC.setText(((Integer) AjouterCommandeController.prixFacture).toString() + " DT");
    }
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient) {
        try {
            ...
            String htmlText = "<p>"
                    ...
                    + "d'un montant de <b>" + ((Integer) AjouterCommandeController.prixFacture).toString() + " DT</b>. <br/>"
