...
public class ListeFormateurController implements Initializable {
    ...
    private void supprimerFormateur(ActionEvent event) throws SQLException {
         if (event.getSource()==zd_supp) {
            ...
            m.setUtilisateurID(zd_tableFormateur.getSelectionModel().getSelectedItem().getUtilisateurID());
            System.out.println(zd_tableFormateur.getSelectionModel().getSelectedItem().getUtilisateurID());
