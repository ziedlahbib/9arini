...
public class DashbordFormateurController implements Initializable {
    ...
    private void gotocategorie(ActionEvent event) throws IOException {
        ...
        /*AnchorPane pane=FXMLLoader.load(getClass().getResource("CategorieGestion.fxml"));
        fenetredash.getChildren().setAll(pane);*/
...
Scene scene=new Scene(page1,1236,785);
    ...
    private void gotocours(ActionEvent event) throws IOException {
       ...
       /* AnchorPane pane=FXMLLoader.load(getClass().getResource("CoursGestion.fxml"));
        fenetredash.getChildren().setAll(pane);*/
...
Scene scene=new Scene(page1,1236,785);
    ...
    private void gotoreclamations(ActionEvent event) {
       /*   Parent page1=FXMLLoader.load(getClass().getResource("Cours.fxml"));
    Scene scene =ayaaaa.getScene();
    scene.setRoot(page1);
    Stage stage =(Stage) ((Node) event.getSource()).getScene().getWindow();
    stage.setScene(scene);
    stage.show();*/
